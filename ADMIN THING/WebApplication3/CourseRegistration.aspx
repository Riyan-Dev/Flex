        ...
        <table class="auto-style2" style="background-color: #0066FF;">
            ...
            <tr>
                <td class="auto-style3" style="color: #000000; background-color: #FFFFFF;">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DBProjConnectionString %>" SelectCommand="SELECT [rollNo], [FirstName] FROM [Student]"></asp:SqlDataSource>
                </td>
                <td class="auto-style4" style="color: #000000; background-color: #FFFFFF;">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:DBProjConnectionString %>" SelectCommand="SELECT [CourseID], [CName] FROM [Courses]"></asp:SqlDataSource>
                </td>
                <td class="auto-style5" style="color: #000000; background-color: #FFFFFF;">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:DBProjConnectionString %>" SelectCommand="SELECT [secID] FROM [Section]"></asp:SqlDataSource>
                </td>
