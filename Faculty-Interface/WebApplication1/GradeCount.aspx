<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GradeCount.aspx.cs" Inherits="WebApplication1.GradeCount" %>
    ...
    <div class="bg" >
        ...
        <div id ="form">
            <form id="form1" runat="server">
                ...
                <div class="row">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" CssClass="auto-style2" DataSourceID="SqlDataSource1" Width="600px">
                        <Columns>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DBProjConnectionString %>" SelectCommand="gradeCount" SelectCommandType="StoredProcedure">
                        <SelectParameters>
