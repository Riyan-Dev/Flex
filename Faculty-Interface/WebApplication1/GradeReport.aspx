<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GradeReport.aspx.cs" Inherits="WebApplication1.GradeReport" %>
    ...
    <div class="bg" >
        ...
        <div id ="form">
            <form id="form1" runat="server">
                ...
                <div class="row1">
                      <div class="col-md-12 school-options-dropdown text-center">
                        <div class="dropdown btn-group">
                            ...
                            <asp:Button CssClass="button" ID="Button2" runat="server" Text="Attendance " Width="150px" OnClick="Button2_Click" />
                            <asp:Button CssClass="button" ID="Button3" runat="server" Text="Evaluation" Width="150px" OnClick="Button3_Click" />
                            <asp:Button CssClass="button" ID="Button4" runat="server" Text="Grade" Width="150px" OnClick="Button4_Click" />
                ...
                <div class="row">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" CssClass="auto-style1" DataSourceID="SqlDataSource1" Width="600px">
                        <Columns>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DBProjConnectionString %>" SelectCommand="gradeReport" SelectCommandType="StoredProcedure">
                        <SelectParameters>
